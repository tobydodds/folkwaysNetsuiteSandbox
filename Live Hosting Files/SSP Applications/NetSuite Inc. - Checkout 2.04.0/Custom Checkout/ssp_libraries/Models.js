...
,	login_sso: function (email, password, redirect)
	{
		'use strict';
...
,	newgenAddLines: function (lines_data)
	{
		'use strict';

		var items = [];

		console.log('newgenaddlines');
		console.log(JSON.stringify(lines_data));
		_.each(lines_data, function (line_data)
		{
			var item = {
					internalid: line_data.internalid.toString()
				,	quantity:  parseInt(line_data.quantity, 10)
				,	options: line_data.options || {}
			};
