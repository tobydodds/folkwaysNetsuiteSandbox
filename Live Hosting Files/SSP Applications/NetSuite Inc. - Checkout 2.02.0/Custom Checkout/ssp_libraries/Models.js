...
,	register: function (user_data)
	{
		...
		else
		{
			...
			if ( result ) {
/*
				var customer_demo = nlapiLoadRecord("customer", nlapiGetUser());
				
				nlapiLogExecution("DEBUG", "DATA", JSON.stringify(customer_demo));
				
				
				customer_demo.setFieldValue("custentity_memberid", user_data.memberid);
				
				nlapiSubmitRecord(customer_demo, true, true);
				
				nlapiLogExecution("DEBUG", "MEMBER ID UPDATED INTO CUSTOMER", nlapiGetUser());
