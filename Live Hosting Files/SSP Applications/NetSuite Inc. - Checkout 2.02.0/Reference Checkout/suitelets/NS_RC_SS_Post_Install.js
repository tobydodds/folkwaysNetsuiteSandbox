function postInstallCombiner ()
{
	try
	{
		var loaded_file = null,
			...
			reference_container_path = "/Web Site Hosting Files/Live Hosting Files/SSP Applications/NetSuite Inc. - Checkout 2.02.0/Reference Checkout",
		...
		"/templates;/js;/css".split(';').forEach(function (path, index)
		{
